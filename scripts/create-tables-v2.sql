...
-- This will only work after you have actual users in auth.users
-- You can remove this section if you don't want sample data

COMMENT ON TABLE user_profiles IS 'User profile information including credits and verification status';
COMMENT ON TABLE analysis_results IS 'Queue analysis results for user accounts';
COMMENT ON TABLE injection_records IS 'Records of account injection purchases and status';

-- Grant necessary permissions
GRANT USAGE ON SCHEMA public TO anon, authenticated;
GRANT ALL ON user_profiles TO authenticated;
GRANT ALL ON analysis_results TO authenticated;
GRANT ALL ON injection_records TO authenticated;
